...
@pytest.fixture
async def client(mock_service, mock_text_processor):  # noqa: ARG001
...
class TestSimpleTTS:
    ...
    async def test_successful_tts_generation(
        self,
        client,
        mock_service,
        mock_text_processor,
        ...
        response = await client.get("/tts/speak?text=Hola estudiantes&grade=5")
    ...
    async def test_default_grade_level(self, client, mock_service, mock_text_processor):
        ...
        response = await client.get("/tts/speak?text=Hola")
...
class TestAdvancedTTS:
    ...
    async def test_successful_generation_with_cache(
        self,
        client,
        mock_service,
        mock_text_processor,
    ...
    async def test_default_values(self, client, mock_service, mock_text_processor):
        ...
        response = await client.post("/tts/generate", json={"text": "Hola"})
...
class TestStreamingTTS:
    ...
    async def test_successful_streaming(
        ...
        response = await client.get("/tts/stream?text=Contenido largo&grade=7")
    ...
    async def test_validation_error_streaming(
        ...
        response = await client.get("/tts/stream?text=invalid&grade=5")
    ...
    async def test_streaming_service_error(
        ...
        response = await client.get("/tts/stream?text=Hola&grade=5")
...
class TestBatchTTS:
    ...
    async def test_successful_batch_generation(
        self,
        client,
        mock_service,
        mock_text_processor,
    ...
    async def test_segment_specific_grade_levels(
        self,
        client,
        mock_service,
        mock_text_processor,
...
class TestHealthCheck:
    ...
    async def test_unhealthy_service(
        self,
        client,
        mock_service,
        mock_text_processor,
